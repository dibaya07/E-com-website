...
export default function ProceedBtn ({price, tax} : proceedBtnProp){
    return(
        <button className="bg-blue-600 text-white w-full py-2 rounded-md disabled:bg-blue-400 disabled:cursor-not-allowed" disabled={price <= 0}>PROCEED TO CHECKOUT</button>
