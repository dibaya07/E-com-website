   ...
   <>
    ...
    <div className="bg-(--gray)  block sm:hidden ">
      <div className="flex text-base bg-white py-1.5 border border-black/6">
        <span className="w-1/2 flex justify-center items-center gap-1.5 border-r border-black/6"> <IoFilter /> Filter</span>
          <span className="w-1/2 flex justify-center items-center gap-1.5 border-l border-black/6"><TiArrowSortedDown /> Sort</span>
      </div>
