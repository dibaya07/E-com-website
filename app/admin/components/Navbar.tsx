...
export default function Navbar() {
  return (
    <div className="flex py-3 bg-white justify-between border-b border-(--gray)">
      ...
      <Link
        href={"/"}
        className="flex justify-start items-center pl-4 w-[38%]  sm:w-[17%] gap-3 cursor-pointer "
      >
      ...
      <span className="bg-(--gray)/40 px-2 py-1 border border-gray-400 flex-1 sm:ml-20 lg:ml-8 lg:mr-96 hidden sm:flex gap-1.5 rounded-md">
        <span className=" flex justify-center items-center mx-1.5 ">
          <IoSearch />
        </span>
        <input type="text" placeholder="Search" />
      </span>
      <div className="sm:w-[14%] flex justify-around items-center text-2xl">
